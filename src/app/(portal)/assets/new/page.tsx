...
type SectionType = 'planes' | 'helicopters' | 'residences' | 'watercraft';
...
export default function NewAssetPage() {
  ...
  useEffect(() => {
    const fetchDirectories = async () => {
      ...
      try {
        // Fetch airports (includes airports and dual-use)
        ...
        // Fetch heliports (includes heliports and dual-use)
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-sm text-muted mt-1">
                        ...
                        {key === 'residences' && 'Homes, villas, meeting rooms, and spaces'}
                        {key === 'watercraft' && 'Yachts and marine vessels'}
                      </p>
                    </button>
                  );
                })}
                  ...
                  <div>
                    ...
                    {airports.length === 0 && (
                      <p className="text-xs text-amber-400 mt-1 flex items-center gap-1">
                        ...
                        No airports found. <Link href="/airfields" className="underline">Add airfields first</Link>
                      </p>
                    )}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    {heliports.length === 0 && (
                      <p className="text-xs text-amber-400 mt-1 flex items-center gap-1">
                        <MapPin className="w-3 h-3" />
                        No heliports found. <Link href="/airfields" className="underline">Add airfields first</Link>
                      </p>
                    )}
                  </div>
                  <div className="col-span-2">
